...
FuncAddress<addresses::DrawMainMenuFuncType> addresses::DrawMainMenuFunc;
...
label_client: {}
    ...
    addresses::DrawMainMenuFunc.Register(baseAddress + DYNADDR(0x72450, 0x30821));
...
label_dedicated: {}
    ...
    addresses::DrawMainMenuFunc.Register(0);
